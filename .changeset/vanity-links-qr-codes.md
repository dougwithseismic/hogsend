...
Migrations `0037`/`0038`/`0039` are additive (nullable columns + indexes) — no data changes, no breaking API changes. New engine dependency: `qrcode` (mirrored in the create-hogsend template).
