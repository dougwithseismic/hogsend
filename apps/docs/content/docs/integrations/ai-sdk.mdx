---
title: Vercel AI SDK
description: Wire the Vercel AI SDK into a Hogsend journey — generateObject for typed slot-filling and generateText with tools for mid-reasoning history reads.
---
...
Related: [AI-personalised onboarding](/docs/recipes/ai-personalized-onboarding), [AI next-best action](/docs/recipes/ai-next-best-action).
