...
The cold-connect page + exchange (the `/link` email-confirm flow, [below](#linking-a-contact-start-vs-link)) is a small consumer route set, mounted on the API only:
