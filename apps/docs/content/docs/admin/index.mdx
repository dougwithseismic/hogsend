---
title: "Admin Guide"
description: "Operating Hogsend -- authentication, monitoring, and management"
---

This guide is for operators -- the people responsible for keeping Hogsend running, managing contacts, debugging journeys, and maintaining email deliverability. If you are writing journey code, start with the [Journeys](/docs/journeys) page instead. If you need raw endpoint definitions, see the [API Reference](/docs/api-reference).
...
For production, create a scoped database-backed key (see [Authentication](/docs/admin/authentication)):
