...
description: "Monitoring, controlling, and debugging journeys"
---

Journeys are the core of Hogsend -- they define how users move through your lifecycle automation. As an operator, you need to monitor their health, control which ones are running, debug failures, and occasionally intervene manually. This page covers all of that.
...
For the full endpoint specification, see the [API Reference](/docs/api-reference).
