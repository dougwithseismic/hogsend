...
description: Forward the right PostHog events to your running app via PostHog's Destinations pipeline — into POST /v1/webhooks/posthog, where they trigger journeys. With screenshots.
---
...
<Cards>
  ...
  <Card title="Webhook Sources" href="/docs/guides/webhook-sources" />
</Cards>
