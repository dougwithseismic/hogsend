...
You're ready. Head to [Journeys](/docs/guides/journeys) to define your first lifecycle flow, or explore the [example journeys](https://github.com/dougwithseismic/hogsend/tree/main/apps/api/src/journeys) that ship with the repo.
