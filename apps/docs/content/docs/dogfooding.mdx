...
<Callout title="This page covers the course loop">
  The course is one loop on our production instance. For the whole thing — the
  docs funnel, referrals, the Discord community, all 45 journeys — see
  [How we run Hogsend on Hogsend](/dogfood).
</Callout>
