...
Related: [AI-personalised onboarding](/docs/recipes/ai-personalized-onboarding) is the simpler Tier-1 version of this pattern; [Vercel AI SDK integration](/docs/integrations/ai-sdk) documents both tiers side by side.
