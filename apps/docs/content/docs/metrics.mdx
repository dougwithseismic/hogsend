...
description: "Real-time system metrics, journey performance tracking, email deliverability trends, and event volume analysis."
---

Hogsend provides a comprehensive metrics API that gives you real-time visibility into your lifecycle automation. All metrics are computed via SQL aggregates on demand -- no pre-computation, no background jobs, no stale data.
