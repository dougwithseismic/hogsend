...
│                       PostHog                           │
│                                                         │
│  user_signed_up ──┐              ┌── email.opened       │
│  feature_used ────┤   webhook    │   email.clicked      │
│  payment_failed ──┤─────────────▶│   email.unsubscribed │
│  [any event] ─────┘              │   journey.completed  │
│                                  └──────────────────────│
└──────────┬──────────────────────────────▲───────────────┘
           │                              │
           │ events in                    │ engagement back
           ▼                              │
┌──────────────────────────────────────────────────────────┐
│                       Hogsend                            │
│                                                          │
│  ┌─────────┐   ┌──────────┐   ┌───────────┐             │
│  │ Ingest  │──▶│ Hatchet  │──▶│ Journeys  │──┐          │
│  │ Pipeline│   │ Routing  │   │ (durable) │  │          │
│  └─────────┘   └──────────┘   └───────────┘  │          │
│       │                                       ▼          │
│       │    ┌──────────┐              ┌──────────┐        │
│       └───▶│ Contacts │              │  Resend  │        │
