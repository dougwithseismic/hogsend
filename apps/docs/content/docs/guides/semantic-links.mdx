...
- **Not free text.** The answer space is whatever you can enumerate as links.
  For a comment box, land the click on a page that collects it — the click
  has already recorded the structured part.
