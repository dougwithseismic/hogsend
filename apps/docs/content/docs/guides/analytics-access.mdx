...
[webhook source](/docs/getting-started/posthog-setup). Non-interactive:
...
deployed, `hogsend connect posthog` finishes the loop — it wires person
reads (the personal API key below) and the PostHog→Hogsend event loop.
