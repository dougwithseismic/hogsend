...
| Hosting | Managed SaaS | Self-hosted, open source -- data in your own Postgres |
...
The pricing and ownership angle is the sharpest contrast. With Hogsend there is no per-profile or per-email charge -- it's open source, self-hosted, and your contact data lives in your own Postgres. You're not buying access to a platform; you're consuming a versioned engine package. You scaffold with `pnpm dlx create-hogsend@latest`, your journeys and templates are content in your repo, and you upgrade the framework with `pnpm up @hogsend/*` -- it is not a fork you maintain a diff against.
