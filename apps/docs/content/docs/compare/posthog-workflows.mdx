...
**Free up to 10,000 messages/mo** | then $0.005 per send, billed through PostHog
...
The economics also change shape as you grow: $0.005 per send is fine until it isn't. At 100,000 sends a month that's $450 a month, forever, on top of your PostHog bill.
...
| Pricing | 10k free messages/mo, then $0.005/send* | Free to self-host (ELv2); you pay your own infra |
