...
1. **[Acquire a Hatchet](/docs/getting-started/hatchet)** — Hogsend's one hard dependency. Get a token from Hatchet Cloud, a self-hosted `hatchet-lite`, or your own engine, and set the three `HATCHET_CLIENT_*` vars. There is **no auto-mint** — bring your own token. This is **Step 1**.
