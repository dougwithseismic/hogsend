...
For more on replay, see [Bulk Operations](/docs/operating/bulk-operations).
...
|---|---|
| Email provider API error | Delivery service issue (Resend by default). Check your provider's status page. |
