...
There are two front-ends over the admin plane: the human [Studio](/docs/operating/studio) UI (Better Auth login — public sign-up is disabled, so the first admin is minted from your server; see [Authentication](/docs/operating/authentication#studio-admin-login)) and machine [API keys](/docs/operating/authentication) for the CLI, CI, and your own code.
