...
<Cards>
  <Card title="Authentication" href="/docs/admin/authentication" />
  <Card title="Contact Management" href="/docs/admin/contacts" />
  <Card title="Journey Operations" href="/docs/admin/journeys" />
  <Card title="Email Operations" href="/docs/admin/emails" />
  <Card title="Monitoring & Alerting" href="/docs/admin/monitoring" />
</Cards>
