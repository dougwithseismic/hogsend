...
description: "Contact import/export, event replay, email resend, batch enrollment, and event deduplication."
---

Hogsend provides bulk operation endpoints for managing contacts and events at scale. These are designed for operational workflows like data migrations, recovery from failures, and batch user management.
