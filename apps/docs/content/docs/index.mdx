...
Hogsend is a TypeScript framework for growth engineering. Identify and enrich the people on your product, react to the events they fire, message them where they are — email, SMS, Discord, Telegram — and measure what each journey moved. Buckets, tracked links, feature flags, funnels, groups, and a Studio to watch it all come built in.
