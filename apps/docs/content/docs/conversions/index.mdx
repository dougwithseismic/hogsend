...
<Callout type="info">
  This is the **outbound** mirror of the [PostHog integration](/docs/integrations/posthog)'s inbound half. That section forwards PostHog events *into* Hogsend to trigger journeys. This one forwards events *out* of PostHog to ad platforms. Same pipeline, opposite direction.
</Callout>
