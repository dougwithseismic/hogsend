...
- [Identifying users](./identifying-users) — the full anonymous → identified flow: server mint, provider wiring, token refresh, folding email/Discord onto the contact.
