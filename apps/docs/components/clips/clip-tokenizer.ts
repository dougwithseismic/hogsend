/**
 * Tiny deterministic TypeScript tokenizer for clip code panels. Not a
 * parser — just enough lexing for beautiful marketing code. No shiki, no
 * async. Ported verbatim from marketing/video/src/lib/code-tokenizer.ts.
 *
