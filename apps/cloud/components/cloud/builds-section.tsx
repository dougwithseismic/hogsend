...
function BuildRow({
  ...
  return (
    <Link
      ...
      className="flex flex-col gap-2 py-4 transition-colors hover:bg-white/[0.02] sm:flex-row sm:items-center sm:justify-between sm:gap-6"
    >
  ...
  return (
    <>
      <div className="flex flex-col gap-0">
        ...
        */}
        <p className="max-w-prose pb-4 text-white/45 text-xs leading-5">
