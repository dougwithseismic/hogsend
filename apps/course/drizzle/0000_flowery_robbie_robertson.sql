...
CREATE UNIQUE INDEX "enrollment_user_course_uq" ON "enrollment" USING btree ("user_id","course_slug");--> statement-breakpoint
CREATE UNIQUE INDEX "lesson_progress_user_course_lesson_uq" ON "lesson_progress" USING btree ("user_id","course_slug","lesson_slug");--> statement-breakpoint
CREATE INDEX "lesson_progress_user_course_idx" ON "lesson_progress" USING btree ("user_id","course_slug");