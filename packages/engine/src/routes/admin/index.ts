...
import { impactOverviewRouter } from "./impact.js";
import { journeyImpactRouter } from "./journey-impact.js";
...
import { targetingRouter } from "./targeting.js";
...
adminRouter.route("/", identityRouter);
...
adminRouter.route("/journeys", journeyImpactRouter);
adminRouter.route("/impact", impactOverviewRouter);
...
adminRouter.route("/referrals", adminReferralsRouter);
adminRouter.route("/flags", adminFlagsRouter);
adminRouter.route("/targeting", targetingRouter);
