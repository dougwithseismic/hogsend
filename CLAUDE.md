...
- **NOT built yet**: the hosted manage page, embed SDK button, `@hogsend/client` `accounts.*`, property-sync cron, Studio panel, and journey-plane re-ingest (so a journey cannot yet trigger on `account.linked`).
